    ...
    <body class="bg-[#1B1B3A]">
        ...
        <div class="h-[90vh] flex">
            <div class="mx-auto min-w-full xl:min-w-[80rem] my-auto px-4 lg:px-12">
                <h1 class="text-4xl font-semibold text-white text-center mb-28 mt-16">Halaman Admin</h1>
                <!-- Start coding here -->
                <div class="bg-white dark:bg-gray-800 relative shadow-md sm:rounded-lg min-h-[10rem] overflow-hidden -mt-16">
                    <div

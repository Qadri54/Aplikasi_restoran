...
Route::middleware(['auth'])->group(function () {
    // admin product route
    Route::get('/admin_dashboard', [ProductController::class, 'get_all'])->name('admin');
...
Route::get('/katalog/{user:id}/{table:no_meja}', [ProductController::class, 'get_all'])->name("katalog.user");
Route::get('/checkout/{table:no_meja}/{user:id}', [OrderController::class, 'checkout'])->name("checkout");
